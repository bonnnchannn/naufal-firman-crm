            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('products.store') }}" method="POST">
                        ...
                        {{-- Tombol Simpan --}}
                        <div class="mt-6">
                            <button type="submit" class="bg-blue-500 hover:bg-red-500  font-bold py-2 px-4 rounded ">
                                Simpan Produk
                            </button>
                            <a href="{{ route('products.index') }}" class="ml-4 bg-blue-500 text-black-600 hover:bg-red-600">Batal</a>
                        </div>
