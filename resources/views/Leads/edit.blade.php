                        ...
                        <div class="border-b border-gray-200 pb-6">
                            <div class="flex items-center mb-2">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="mt-1 text-sm text-gray-600">Perbarui informasi kontak dan status lead.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-y-8">
                            ...
                            <div class="group">
                                ...
                                <div class="relative">
                                    <input type="text"
                                           ...
                                           placeholder="Masukkan nama lengkap lead"
                                           required>
                                ...
                                @else
                                    <p class="mt-2 text-sm text-gray-500 flex items-center">
                                        ...
                                        Nama akan digunakan untuk personalisasi komunikasi
                                    </p>
                                @enderror
                            </div>
                            ...
                            <div class="group">
                                ...
                                @else
                                    <p class="mt-2 text-sm text-gray-500 flex items-center">
                                        ...
                                        Pastikan email valid untuk follow-up dan notifikasi
                                    </p>
                                @enderror
                            </div>
                            ...
                            <div class="group">
                                ...
                                @else
                                    <p class="mt-2 text-sm text-gray-500 flex items-center">
                                        ...
                                        Status membantu tim melacak progres follow-up
                                    </p>
                                @enderror
                            </div>
                            ...
                            <div class="bg-blue-50 rounded-lg p-4 border border-blue-200">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-3">
                                        <h4 class="text-sm font-medium text-blue-800">Catatan Saat Mengedit</h4>
                                        <div class="mt-2 text-sm text-blue-700">
                                            <ul class="list-disc pl-5 space-y-1">
                                                <li>Pastikan data terbaru dan akurat</li>
                                                <li>Status "Converted" hanya bisa diatur oleh sistem</li>
                                                <li>Catat perubahan penting di catatan tim jika diperlukan</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
